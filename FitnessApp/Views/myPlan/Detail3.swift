...
//                    ScrollView(.horizontal) {
//                        HStack {
//                            ImageViewWithText(imageName: "meditation", text: "meditation is great for relaxation")
//                                .padding(.trailing, -15)
//                            ImageViewWithText(imageName: "run", text: "sports, music and more energy")
//                                .padding(.trailing, -42)
//                            ImageViewWithText(imageName: "powerText", text: "something for motivation")
//                                
//                        }
//                    }
//                    
